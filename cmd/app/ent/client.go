...
func (c *Client) Intercept(interceptors ...Interceptor) {
	c.BusinessAccount.Intercept(interceptors...)
...
type (
	hooks struct {
		BusinessAccount, Comment, Post, User []ent.Hook
	}
	inters struct {
		BusinessAccount, Comment, Post, User []ent.Interceptor
	}
)
