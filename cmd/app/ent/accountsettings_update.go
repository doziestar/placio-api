...
func (asu *AccountSettingsUpdate) SetID(s string) *AccountSettingsUpdate {
	asu.mutation.SetID(s)
	return asu
}

// SetAccountID sets the "AccountID" field.
func (asu *AccountSettingsUpdate) SetAccountID(s string) *AccountSettingsUpdate {
	asu.mutation.SetAccountID(s)
	return asu
}
...
func (asu *AccountSettingsUpdate) SetBusinessAccountID(s string) *AccountSettingsUpdate {
	asu.mutation.SetBusinessAccountID(s)
	return asu
}

// SetBusinessAccountID sets the "business_account" edge to the BusinessAccount entity by ID.
func (asu *AccountSettingsUpdate) SetBusinessAccountID(id int) *AccountSettingsUpdate {
	asu.mutation.SetBusinessAccountID(id)
	return asu
}

// SetBusinessAccount sets the "business_account" edge to the BusinessAccount entity.
func (asu *AccountSettingsUpdate) SetBusinessAccount(b *BusinessAccount) *AccountSettingsUpdate {
...
func (asu *AccountSettingsUpdate) check() error {
	if _, ok := asu.mutation.BusinessAccountID(); asu.mutation.BusinessAccountCleared() && !ok {
		return errors.New(`ent: clearing a required unique edge "AccountSettings.business_account"`)
	}
	return nil
}
...
func (asu *AccountSettingsUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(accountsettings.Table, accountsettings.Columns, sqlgraph.NewFieldSpec(accountsettings.FieldID, field.TypeInt))
	...
	if value, ok := asu.mutation.ID(); ok {
	...
	if value, ok := asu.mutation.BusinessAccountID(); ok {
...
// SetID sets the "ID" field.
func (asuo *AccountSettingsUpdateOne) SetID(s string) *AccountSettingsUpdateOne {
	asuo.mutation.SetID(s)
	return asuo
}

// SetAccountID sets the "AccountID" field.
func (asuo *AccountSettingsUpdateOne) SetAccountID(s string) *AccountSettingsUpdateOne {
	asuo.mutation.SetAccountID(s)
	return asuo
}
...
// SetBusinessAccountID sets the "BusinessAccountID" field.
func (asuo *AccountSettingsUpdateOne) SetBusinessAccountID(s string) *AccountSettingsUpdateOne {
	asuo.mutation.SetBusinessAccountID(s)
	return asuo
}

// SetBusinessAccountID sets the "business_account" edge to the BusinessAccount entity by ID.
func (asuo *AccountSettingsUpdateOne) SetBusinessAccountID(id int) *AccountSettingsUpdateOne {
	asuo.mutation.SetBusinessAccountID(id)
	return asuo
}

// SetBusinessAccount sets the "business_account" edge to the BusinessAccount entity.
func (asuo *AccountSettingsUpdateOne) SetBusinessAccount(b *BusinessAccount) *AccountSettingsUpdateOne {
...
func (asuo *AccountSettingsUpdateOne) sqlSave(ctx context.Context) (_node *AccountSettings, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`ent: missing "AccountSettings.id" for update`)}
	}
	...
	if value, ok := asuo.mutation.ID(); ok {
		_spec.SetField(accountsettings.FieldID, field.TypeString, value)
	}
	...
	if value, ok := asuo.mutation.BusinessAccountID(); ok {
		_spec.SetField(accountsettings.FieldBusinessAccountID, field.TypeString, value)
	}
