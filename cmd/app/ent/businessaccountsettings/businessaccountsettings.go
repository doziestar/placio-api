...
const (
	// Label holds the string label denoting the businessaccountsettings type in the database.
	Label = "business_account_settings"
	// FieldID holds the string denoting the id field in the database.
	FieldID = "id"
	// FieldBusinessAccountSettingsID holds the string denoting the businessaccountsettingsid field in the database.
	FieldBusinessAccountSettingsID = "business_account_settings_id"
	...
	// Table holds the table name of the businessaccountsettings in the database.
	Table = "business_account_settings"
	// BusinessAccountTable is the table that holds the business_account relation/edge.
	BusinessAccountTable = "business_account_settings"
...
// Columns holds all SQL columns for businessaccountsettings fields.
var Columns = []string{
	FieldID,
	FieldBusinessAccountSettingsID,
...
// ForeignKeys holds the SQL foreign-keys that are owned by the "business_account_settings"
...
// OrderOption defines the ordering options for the BusinessAccountSettings queries.
...
// ByBusinessAccountSettingsID orders the results by the BusinessAccountSettingsID field.
func ByBusinessAccountSettingsID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldBusinessAccountSettingsID, opts...).ToFunc()
}
