...
import click
import logging
from africa_insight.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("africa_insight.app.utils.logging.click.style",
    ...
    @mock.patch("africa_insight.app.utils.logging.logging.Formatter")
