...
NAME = 'africa_insight'
SHORT_DESCRIPTION = "Api for my gpt"
URL = "https://github.com/cnc-technologies/placio-api/africa-insite"
AUTHOR = 'Okafor C. Chidozie'
...
setup(name=NAME,
      ...
      url=URL,
      packages=find_packages(include=["africa_insight*"],
