...
func (ec *EventCreate) check() error {
	if v, ok := ec.mutation.EventType(); ok {
		if err := event.EventTypeValidator(v); err != nil {
			return &ValidationError{Name: "EventType", err: fmt.Errorf(`placio_api: validator failed for field "Event.EventType": %w`, err)}
		}
	}
	if v, ok := ec.mutation.Frequency(); ok {
		if err := event.FrequencyValidator(v); err != nil {
			return &ValidationError{Name: "frequency", err: fmt.Errorf(`placio_api: validator failed for field "Event.frequency": %w`, err)}
		}
	}
	if v, ok := ec.mutation.VenueType(); ok {
		if err := event.VenueTypeValidator(v); err != nil {
			return &ValidationError{Name: "venue_type", err: fmt.Errorf(`placio_api: validator failed for field "Event.venue_type": %w`, err)}
		}
	}
	if _, ok := ec.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`placio_api: missing required field "Event.createdAt"`)}
	}
	if _, ok := ec.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`placio_api: missing required field "Event.updatedAt"`)}
	}
	if _, ok := ec.mutation.FollowerCount(); !ok {
		return &ValidationError{Name: "follower_count", err: errors.New(`placio_api: missing required field "Event.follower_count"`)}
	}
	if _, ok := ec.mutation.FollowingCount(); !ok {
		return &ValidationError{Name: "following_count", err: errors.New(`placio_api: missing required field "Event.following_count"`)}
	}
	if _, ok := ec.mutation.IsPremium(); !ok {
		return &ValidationError{Name: "is_Premium", err: errors.New(`placio_api: missing required field "Event.is_Premium"`)}
	}
	if _, ok := ec.mutation.IsPublished(); !ok {
		return &ValidationError{Name: "is_published", err: errors.New(`placio_api: missing required field "Event.is_published"`)}
	}
	if _, ok := ec.mutation.IsOnline(); !ok {
		return &ValidationError{Name: "is_Online", err: errors.New(`placio_api: missing required field "Event.is_Online"`)}
	}
	if _, ok := ec.mutation.IsFree(); !ok {
		return &ValidationError{Name: "is_Free", err: errors.New(`placio_api: missing required field "Event.is_Free"`)}
	}
	if _, ok := ec.mutation.IsPaid(); !ok {
		return &ValidationError{Name: "is_Paid", err: errors.New(`placio_api: missing required field "Event.is_Paid"`)}
	}
	if _, ok := ec.mutation.IsOnlineOnly(); !ok {
		return &ValidationError{Name: "is_Online_Only", err: errors.New(`placio_api: missing required field "Event.is_Online_Only"`)}
	}
	if _, ok := ec.mutation.IsInPersonOnly(); !ok {
		return &ValidationError{Name: "is_In_Person_Only", err: errors.New(`placio_api: missing required field "Event.is_In_Person_Only"`)}
	}
	if _, ok := ec.mutation.IsHybrid(); !ok {
		return &ValidationError{Name: "is_Hybrid", err: errors.New(`placio_api: missing required field "Event.is_Hybrid"`)}
	}
	if _, ok := ec.mutation.IsOnlineAndInPerson(); !ok {
		return &ValidationError{Name: "is_Online_And_In_Person", err: errors.New(`placio_api: missing required field "Event.is_Online_And_In_Person"`)}
	}
	if _, ok := ec.mutation.IsOnlineAndInPersonOnly(); !ok {
		return &ValidationError{Name: "is_Online_And_In_Person_Only", err: errors.New(`placio_api: missing required field "Event.is_Online_And_In_Person_Only"`)}
	}
	if _, ok := ec.mutation.IsOnlineAndInPersonOrHybrid(); !ok {
		return &ValidationError{Name: "is_Online_And_In_Person_Or_Hybrid", err: errors.New(`placio_api: missing required field "Event.is_Online_And_In_Person_Or_Hybrid"`)}
	}
	if _, ok := ec.mutation.LikedByCurrentUser(); !ok {
		return &ValidationError{Name: "likedByCurrentUser", err: errors.New(`placio_api: missing required field "Event.likedByCurrentUser"`)}
	}
	if _, ok := ec.mutation.FollowedByCurrentUser(); !ok {
		return &ValidationError{Name: "followedByCurrentUser", err: errors.New(`placio_api: missing required field "Event.followedByCurrentUser"`)}
	}
	return nil
}
