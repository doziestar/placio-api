	...
	if len(nodes) == 0 {
		...
		if query := eq.withEventCategoryAssignments; query != nil {
			if err := eq.loadEventCategoryAssignments(ctx, query, nodes, 
				...
				func(n *Event, e *CategoryAssignment){ n.Edges.EventCategoryAssignments = append(n.Edges.EventCategoryAssignments, e) }); err != nil {
				return nil, err
			}
		}
		...
		if query := eq.withBusinessFollowers; query != nil {
			if err := eq.loadBusinessFollowers(ctx, query, nodes, 
				...
				func(n *Event, e *BusinessFollowEvent){ n.Edges.BusinessFollowers = append(n.Edges.BusinessFollowers, e) }); err != nil {
				return nil, err
			}
		}
