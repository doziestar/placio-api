	...
	if len(nodes) == 0 {
		...
		if query := piq.withAttributes; query != nil {
			if err := piq.loadAttributes(ctx, query, nodes, 
				...
				func(n *PlaceInventory, e *PlaceInventoryAttribute){ n.Edges.Attributes = append(n.Edges.Attributes, e) }); err != nil {
				return nil, err
			}
		}
		...
		if query := piq.withTransactionHistories; query != nil {
			if err := piq.loadTransactionHistories(ctx, query, nodes, 
				...
				func(n *PlaceInventory, e *TransactionHistory){ n.Edges.TransactionHistories = append(n.Edges.TransactionHistories, e) }); err != nil {
				return nil, err
			}
		}
		if query := piq.withReservationBlocks; query != nil {
			if err := piq.loadReservationBlocks(ctx, query, nodes, 
				...
				func(n *PlaceInventory, e *ReservationBlock){ n.Edges.ReservationBlocks = append(n.Edges.ReservationBlocks, e) }); err != nil {
				return nil, err
			}
		}
