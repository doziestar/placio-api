	...
	if len(nodes) == 0 {
		...
		if query := uq.withFollowedBusinesses; query != nil {
			if err := uq.loadFollowedBusinesses(ctx, query, nodes, 
				...
				func(n *User, e *UserFollowBusiness){ n.Edges.FollowedBusinesses = append(n.Edges.FollowedBusinesses, e) }); err != nil {
				return nil, err
			}
		}
		if query := uq.withFollowerBusinesses; query != nil {
			if err := uq.loadFollowerBusinesses(ctx, query, nodes, 
				...
				func(n *User, e *BusinessFollowUser){ n.Edges.FollowerBusinesses = append(n.Edges.FollowerBusinesses, e) }); err != nil {
				return nil, err
			}
		}
		...
		if query := uq.withCategoryAssignments; query != nil {
			if err := uq.loadCategoryAssignments(ctx, query, nodes, 
				...
				func(n *User, e *CategoryAssignment){ n.Edges.CategoryAssignments = append(n.Edges.CategoryAssignments, e) }); err != nil {
				return nil, err
			}
		}
		...
		if query := uq.withTransactionHistories; query != nil {
			if err := uq.loadTransactionHistories(ctx, query, nodes, 
				...
				func(n *User, e *TransactionHistory){ n.Edges.TransactionHistories = append(n.Edges.TransactionHistories, e) }); err != nil {
				return nil, err
			}
		}
