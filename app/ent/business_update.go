...
func (bu *BusinessUpdate) SetFollowerCount(i int) *BusinessUpdate {
	bu.mutation.ResetFollowerCount()
	bu.mutation.SetFollowerCount(i)
	return bu
}

// SetNillableFollowerCount sets the "follower_count" field if the given value is not nil.
func (bu *BusinessUpdate) SetNillableFollowerCount(i *int) *BusinessUpdate {
	if i != nil {
		bu.SetFollowerCount(*i)
	}
	return bu
}

// AddFollowerCount adds i to the "follower_count" field.
func (bu *BusinessUpdate) AddFollowerCount(i int) *BusinessUpdate {
	bu.mutation.AddFollowerCount(i)
	return bu
}
...
func (bu *BusinessUpdate) AddStaffIDs(ids ...string) *BusinessUpdate {
	bu.mutation.AddStaffIDs(ids...)
	return bu
}

// AddStaffs adds the "staffs" edges to the Staff entity.
func (bu *BusinessUpdate) AddStaffs(s ...*Staff) *BusinessUpdate {
	ids := make([]string, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return bu.AddStaffIDs(ids...)
}

// AddPlanIDs adds the "plans" edge to the Plan entity by IDs.
func (bu *BusinessUpdate) AddPlanIDs(ids ...string) *BusinessUpdate {
	bu.mutation.AddPlanIDs(ids...)
	return bu
}

// AddPlans adds the "plans" edges to the Plan entity.
func (bu *BusinessUpdate) AddPlans(p ...*Plan) *BusinessUpdate {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
func (bu *BusinessUpdate) ClearStaffs() *BusinessUpdate {
	bu.mutation.ClearStaffs()
	return bu
}

// RemoveStaffIDs removes the "staffs" edge to Staff entities by IDs.
func (bu *BusinessUpdate) RemoveStaffIDs(ids ...string) *BusinessUpdate {
	bu.mutation.RemoveStaffIDs(ids...)
	return bu
}

// RemoveStaffs removes "staffs" edges to Staff entities.
func (bu *BusinessUpdate) RemoveStaffs(s ...*Staff) *BusinessUpdate {
	ids := make([]string, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return bu.RemoveStaffIDs(ids...)
}

// ClearPlans clears all "plans" edges to the Plan entity.
func (bu *BusinessUpdate) ClearPlans() *BusinessUpdate {
	bu.mutation.ClearPlans()
	return bu
}

// RemovePlanIDs removes the "plans" edge to Plan entities by IDs.
func (bu *BusinessUpdate) RemovePlanIDs(ids ...string) *BusinessUpdate {
	bu.mutation.RemovePlanIDs(ids...)
	return bu
}

// RemovePlans removes "plans" edges to Plan entities.
func (bu *BusinessUpdate) RemovePlans(p ...*Plan) *BusinessUpdate {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
func (bu *BusinessUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := bu.mutation.FollowerCount(); ok {
		_spec.SetField(business.FieldFollowerCount, field.TypeInt, value)
	}
	if value, ok := bu.mutation.AddedFollowerCount(); ok {
		_spec.AddField(business.FieldFollowerCount, field.TypeInt, value)
	}
	...
	if nodes := bu.mutation.RemovedStaffsIDs(); len(nodes) > 0 && !bu.mutation.StaffsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   business.StaffsTable,
	...
	if nodes := bu.mutation.StaffsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   business.StaffsTable,
	...
	if bu.mutation.PlansCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: true,
			Table:   business.PlansTable,
			Columns: business.PlansPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetFollowerCount sets the "follower_count" field.
func (buo *BusinessUpdateOne) SetFollowerCount(i int) *BusinessUpdateOne {
	buo.mutation.ResetFollowerCount()
	buo.mutation.SetFollowerCount(i)
	return buo
}

// SetNillableFollowerCount sets the "follower_count" field if the given value is not nil.
func (buo *BusinessUpdateOne) SetNillableFollowerCount(i *int) *BusinessUpdateOne {
	if i != nil {
		buo.SetFollowerCount(*i)
	}
	return buo
}

// AddFollowerCount adds i to the "follower_count" field.
func (buo *BusinessUpdateOne) AddFollowerCount(i int) *BusinessUpdateOne {
	buo.mutation.AddFollowerCount(i)
	return buo
}
...
// AddStaffIDs adds the "staffs" edge to the Staff entity by IDs.
func (buo *BusinessUpdateOne) AddStaffIDs(ids ...string) *BusinessUpdateOne {
	buo.mutation.AddStaffIDs(ids...)
	return buo
}

// AddStaffs adds the "staffs" edges to the Staff entity.
func (buo *BusinessUpdateOne) AddStaffs(s ...*Staff) *BusinessUpdateOne {
	ids := make([]string, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return buo.AddStaffIDs(ids...)
}

// AddPlanIDs adds the "plans" edge to the Plan entity by IDs.
func (buo *BusinessUpdateOne) AddPlanIDs(ids ...string) *BusinessUpdateOne {
	buo.mutation.AddPlanIDs(ids...)
	return buo
}

// AddPlans adds the "plans" edges to the Plan entity.
func (buo *BusinessUpdateOne) AddPlans(p ...*Plan) *BusinessUpdateOne {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
// ClearStaffs clears all "staffs" edges to the Staff entity.
func (buo *BusinessUpdateOne) ClearStaffs() *BusinessUpdateOne {
	buo.mutation.ClearStaffs()
	return buo
}

// RemoveStaffIDs removes the "staffs" edge to Staff entities by IDs.
func (buo *BusinessUpdateOne) RemoveStaffIDs(ids ...string) *BusinessUpdateOne {
	buo.mutation.RemoveStaffIDs(ids...)
	return buo
}

// RemoveStaffs removes "staffs" edges to Staff entities.
func (buo *BusinessUpdateOne) RemoveStaffs(s ...*Staff) *BusinessUpdateOne {
	ids := make([]string, len(s))
	for i := range s {
		ids[i] = s[i].ID
	}
	return buo.RemoveStaffIDs(ids...)
}

// ClearPlans clears all "plans" edges to the Plan entity.
func (buo *BusinessUpdateOne) ClearPlans() *BusinessUpdateOne {
	buo.mutation.ClearPlans()
	return buo
}

// RemovePlanIDs removes the "plans" edge to Plan entities by IDs.
func (buo *BusinessUpdateOne) RemovePlanIDs(ids ...string) *BusinessUpdateOne {
	buo.mutation.RemovePlanIDs(ids...)
	return buo
}

// RemovePlans removes "plans" edges to Plan entities.
func (buo *BusinessUpdateOne) RemovePlans(p ...*Plan) *BusinessUpdateOne {
	ids := make([]string, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
...
func (buo *BusinessUpdateOne) sqlSave(ctx context.Context) (_node *Business, err error) {
	...
	if value, ok := buo.mutation.FollowerCount(); ok {
		_spec.SetField(business.FieldFollowerCount, field.TypeInt, value)
	}
	if value, ok := buo.mutation.AddedFollowerCount(); ok {
		_spec.AddField(business.FieldFollowerCount, field.TypeInt, value)
	}
	...
	if nodes := buo.mutation.RemovedStaffsIDs(); len(nodes) > 0 && !buo.mutation.StaffsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   business.StaffsTable,
	...
	if nodes := buo.mutation.StaffsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2M,
			Inverse: false,
			Table:   business.StaffsTable,
