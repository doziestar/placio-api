...
func (pq *PermissionQuery) QueryStaffs() *StaffQuery {
...
func (pq *PermissionQuery) WithStaffs(opts ...func(*StaffQuery)) *PermissionQuery {
	query := (&StaffClient{config: pq.config}).Query()
...
func (pq *PermissionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Permission, error) {
	...
	if query := pq.withStaffs; query != nil {
		if err := pq.loadStaffs(ctx, query, nodes,
			func(n *Permission) { n.Edges.Staffs = []*Staff{} },
			func(n *Permission, e *Staff) { n.Edges.Staffs = append(n.Edges.Staffs, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (pq *PermissionQuery) loadStaffs(ctx context.Context, query *StaffQuery, nodes []*Permission, init func(*Permission), assign func(*Permission, *Staff)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(permission.StaffsTable)
		s.Join(joinT).On(s.C(staff.FieldID), joinT.C(permission.StaffsPrimaryKey[0]))
		s.Where(sql.InValues(joinT.C(permission.StaffsPrimaryKey[1]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(permission.StaffsPrimaryKey[1]))
