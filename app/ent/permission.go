...
func (e PermissionEdges) StaffsOrErr() ([]*Staff, error) {
	if e.loadedTypes[0] {
		return e.Staffs, nil
	}
...
// QueryStaffs queries the "staffs" edge of the Permission entity.
func (pe *Permission) QueryStaffs() *StaffQuery {
	return NewPermissionClient(pe.config).QueryStaffs(pe)
}
