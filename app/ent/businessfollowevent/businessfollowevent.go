...
const (
	// Label holds the string label denoting the businessfollowevent type in the database.
	...
	EdgeEvent = "event"
	// Table holds the table name of the businessfollowevent in the database.
