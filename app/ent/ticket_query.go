...
func (tq *TicketQuery) FirstID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (tq *TicketQuery) FirstIDX(ctx context.Context) string {
...
func (tq *TicketQuery) OnlyID(ctx context.Context) (id string, err error) {
	var ids []string
...
func (tq *TicketQuery) OnlyIDX(ctx context.Context) string {
...
func (tq *TicketQuery) IDs(ctx context.Context) (ids []string, err error) {
...
func (tq *TicketQuery) IDsX(ctx context.Context) []string {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tq *TicketQuery) loadEvent(ctx context.Context, query *EventQuery, nodes []*Ticket, init func(*Ticket), assign func(*Ticket, *Event)) error {
	...
	for _, n := range neighbors {
		nodes, ok := nodeids[n.ID]
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "event_tickets" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
