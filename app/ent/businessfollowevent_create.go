...
func (bfec *BusinessFollowEventCreate) check() error {
	if _, ok := bfec.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "createdAt", err: errors.New(`placio_api: missing required field "BusinessFollowEvent.createdAt"`)}
	}
	if _, ok := bfec.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updatedAt", err: errors.New(`placio_api: missing required field "BusinessFollowEvent.updatedAt"`)}
	}
	if _, ok := bfec.mutation.BusinessID(); !ok {
		return &ValidationError{Name: "business", err: errors.New(`placio_api: missing required edge "BusinessFollowEvent.business"`)}
	}
	if _, ok := bfec.mutation.EventID(); !ok {
		return &ValidationError{Name: "event", err: errors.New(`placio_api: missing required edge "BusinessFollowEvent.event"`)}
	}
	return nil
}
