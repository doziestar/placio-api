...
func (awc *AccountWalletCreate) check() error {
	if _, ok := awc.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`placio_api: missing required field "AccountWallet.user_id"`)}
	}
	if _, ok := awc.mutation.BusinessID(); !ok {
		return &ValidationError{Name: "business_id", err: errors.New(`placio_api: missing required field "AccountWallet.business_id"`)}
	}
	if _, ok := awc.mutation.Balance(); !ok {
		return &ValidationError{Name: "balance", err: errors.New(`placio_api: missing required field "AccountWallet.balance"`)}
	}
	if _, ok := awc.mutation.TotalDeposited(); !ok {
		return &ValidationError{Name: "total_deposited", err: errors.New(`placio_api: missing required field "AccountWallet.total_deposited"`)}
	}
	if _, ok := awc.mutation.TotalWithdrawn(); !ok {
		return &ValidationError{Name: "total_withdrawn", err: errors.New(`placio_api: missing required field "AccountWallet.total_withdrawn"`)}
	}
	if _, ok := awc.mutation.TotalEarned(); !ok {
		return &ValidationError{Name: "total_earned", err: errors.New(`placio_api: missing required field "AccountWallet.total_earned"`)}
	}
	if _, ok := awc.mutation.TotalSpent(); !ok {
		return &ValidationError{Name: "total_spent", err: errors.New(`placio_api: missing required field "AccountWallet.total_spent"`)}
	}
	if _, ok := awc.mutation.TotalRefunded(); !ok {
		return &ValidationError{Name: "total_refunded", err: errors.New(`placio_api: missing required field "AccountWallet.total_refunded"`)}
	}
	if _, ok := awc.mutation.TotalFees(); !ok {
		return &ValidationError{Name: "total_fees", err: errors.New(`placio_api: missing required field "AccountWallet.total_fees"`)}
	}
	if _, ok := awc.mutation.TotalTax(); !ok {
		return &ValidationError{Name: "total_tax", err: errors.New(`placio_api: missing required field "AccountWallet.total_tax"`)}
	}
	if _, ok := awc.mutation.TotalDiscount(); !ok {
		return &ValidationError{Name: "total_discount", err: errors.New(`placio_api: missing required field "AccountWallet.total_discount"`)}
	}
	if _, ok := awc.mutation.TotalRevenue(); !ok {
		return &ValidationError{Name: "total_revenue", err: errors.New(`placio_api: missing required field "AccountWallet.total_revenue"`)}
	}
	if _, ok := awc.mutation.TotalExpenses(); !ok {
		return &ValidationError{Name: "total_expenses", err: errors.New(`placio_api: missing required field "AccountWallet.total_expenses"`)}
	}
	if _, ok := awc.mutation.TotalProfit(); !ok {
		return &ValidationError{Name: "total_profit", err: errors.New(`placio_api: missing required field "AccountWallet.total_profit"`)}
	}
	if _, ok := awc.mutation.TotalLoss(); !ok {
		return &ValidationError{Name: "total_loss", err: errors.New(`placio_api: missing required field "AccountWallet.total_loss"`)}
	}
	return nil
}
