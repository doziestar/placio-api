...
type FAQService interface {
	CreateFAQ(ctx context.Context, businessID string, faqData *FAQDto) (*ent.FAQ, error)
...
func (s *FAQServiceImpl) CreateFAQ(ctx context.Context, businessID string, faqData *FAQDto) (*ent.FAQ, error) {
