...
import click
import logging
from askai.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("askai.app.utils.logging.click.style",
    ...
    @mock.patch("askai.app.utils.logging.logging.Formatter")
