...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/likes/place/check/{placeID}": {
            "get": {
                ...
                "operationId": "user-check-like-place",
                "parameters": [
                    {
                        "type": "string",
                ...
                "responses": {
                    "200": {
                        "description": "Like status returned successfully",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/follow/check/business/{businessID}": {
            "get": {
                ...
                "operationId": "user-check-follow-business",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Business ID",
        ...
        "/follow/check/event/{eventID}": {
            "get": {
                ...
                "operationId": "user-check-follow-event",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Event ID",
        ...
        "/follow/check/place/{placeID}": {
            "get": {
                ...
                "operationId": "user-check-follow-place",
                "parameters": [
                    {
                        "type": "string",
                        "description": "Place ID",
        ...
        "/follow/check/user/{followedID}": {
            "get": {
                ...
                "operationId": "user-check-follow-user",
                "parameters": [
                    {
                        "type": "string",
                        "description": "User ID",
        ...
        "placio-app_ent.BusinessEdges": {
            ...
            "properties": {
                "businessFollowEvents": {
                    "description": "BusinessFollowEvents holds the value of the businessFollowEvents edge.",
                    "type": "array",
                    "items": {
        ...
        "placio-app_ent.Event": {
            ...
            "properties": {
                ...
                "frequency_day_of_month": {
                    "description": "FrequencyDayOfMonth holds the value of the \"frequency_day_of_month\" field.",
                    "type": "string"
                },
                "frequency_day_of_week": {
                    "description": "FrequencyDayOfWeek holds the value of the \"frequency_day_of_week\" field.",
                    "type": "string"
                },
                "frequency_interval": {
                    "description": "FrequencyInterval holds the value of the \"frequency_interval\" field.",
                    "type": "string"
                },
                "frequency_month_of_year": {
                    "description": "FrequencyMonthOfYear holds the value of the \"frequency_month_of_year\" field.",
                    "type": "string"
                },
                "id": {
                    "description": "ID of the ent.",
        ...
        "placio-app_ent.EventEdges": {
            ...
            "properties": {
                ...
                "event_category_assignments": {
                    "description": "EventCategoryAssignments holds the value of the event_category_assignments edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/placio-app_ent.CategoryAssignment"
                    }
